# Contributing to `word-documentation`

Love word-documentation and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/rollup-umd/word-documentation/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/word-documentation.git
   # Navigate to the newly cloned directory
   cd word-documentation
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/kopax/word-documentation.git
   ```
